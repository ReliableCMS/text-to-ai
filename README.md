...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/text-to-ai
```

A live public deployment of this template is available at [https://text-to-ai.templates.workers.dev](https://text-to-ai.templates.workers.dev)
